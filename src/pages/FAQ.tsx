...
const faqs = [
            ...
            <div>
                ...
                <div className="mb-4">
                    ...
                    <ul className="list-disc pl-6 mt-2 space-y-1">
                        ...
                        <li><span className="font-bold">Cigna:</span> Chiropractic care is covered, including Cigna International.</li>
                ...
                <div className="mb-2">
                    ...
                    <ul className="list-disc pl-6 mt-2 space-y-1">
                        ...
                        <li>While most insurance plans cover a range of chiropractic, physical therapy, acupuncture and occupational therapy, it's advisable to check with our office for insurance verification.</li>
        ...
        a: (
            <div>
                ...
                <ul className="list-disc pl-6 space-y-3 mb-4">
                    <li>
                        <span className="font-bold">No Doctor Referral Required for Most Services:</span> For services like Chiropractic and Acupuncture, you typically do not need a referral from a medical doctor to initiate treatment. We operate as a portal of entry for your musculoskeletal and wellness needs, allowing you to seek our expertise directly.
                    </li>
                    <li>
                        <span className="font-bold">Physical Therapy and Occupational Therapy - New Laws and Portal of Entry Care:</span> In recent years, there have been significant changes in healthcare regulations that are particularly beneficial to our patients. In New York, Physical Therapists and Occupational Therapists can now see patients without the need for a medical referral for the first month of care. This means that if you're seeking Physical Therapy or Occupational Therapy services, you can come directly to SEVA Health and Wellness without having to first see a physician for a referral.
                    </li>
                    <li>
                        <span className="font-bold">Insurance and Referral Requirements:</span> It's important to note that insurance coverage for our services can vary. While many insurance plans do not require a doctor's referral for Chiropractic, Acupuncture, or Massage Therapy, some may request a referral for coverage, and this can depend on the specific terms of your insurance plan. Physical Therapy and Occupational Therapy coverage may also differ among insurance providers, so we recommend checking with your insurance company to understand your specific requirements.
                    </li>
                </ul>
        ...
        a: (
            <div>
                ...
                <ul className="list-disc pl-6 mb-4 space-y-2">
                    ...
                    <li><span className="font-bold">Flexible Scheduling:</span> Our facility offers a variety of services, and the availability of same-day appointments may vary by service type. Some services, such as Chiropractic care and Acupuncture, may be more readily available for same-day appointments, while others, like Occupational Therapy, Physical Therapy, or certain Massage Therapy sessions, may require a bit more lead time to schedule. We can also coordinate care with NYC assisted living facilities.</li>
    ...
    },
    {
        ...
        a: (
            <div>
                ...
                <ul className="list-disc pl-6 mb-4 space-y-2">
                    <li><span className="font-bold">Chiropractic and Physical Therapy:</span> Combining chiropractic adjustments with physical therapy can be particularly effective for musculoskeletal issues. Chiropractic care can help address joint misalignments, while physical therapy can focus on strengthening and rehabilitating muscles.</li>
                    <li><span className="font-bold">Physical Therapy and Massage Therapy:</span> A session that combines physical therapy exercises and techniques with massage therapy can provide a well-rounded approach to healing. Physical therapy helps improve mobility, while massage therapy can relieve muscle tension and reduce pain.</li>
                    <li><span className="font-bold">Acupuncture and Chiropractic:</span> For patients seeking relief from pain and discomfort, a session that combines acupuncture and chiropractic care can address both structural and energy-related issues, promoting overall well-being.</li>
                    <li><span className="font-bold">Occupational Therapy and Massage Therapy:</span> Patients with specific functional limitations can benefit from occupational therapy, while massage therapy can help reduce stress and enhance relaxation, making it an excellent combination for those looking to improve their overall quality of life.</li>
                    <li><span className="font-bold">Acupuncture and Massage Therapy:</span> Combining acupuncture and massage therapy can be an excellent choice for relaxation and stress relief, as well as for addressing specific conditions that may benefit from the holistic approach of both therapies.</li>
                </ul>
    ...
    {
        q: 'How long does a chiropractic treatment session last?',
        a: (
            <div>
                <p className="mb-4">At SEVA Health and Wellness, we understand that our patients often have busy schedules, and we aim to provide effective and efficient care while also ensuring your comfort. The duration of a chiropractic treatment session can vary depending on several factors, including the specific needs and conditions of the patient. On average, a chiropractic treatment session typically lasts between <span className="font-bold">30-45 minutes</span>.</p>
                <p className="mb-4"><span className="font-bold">Initial Appointment:</span> The initial chiropractic appointment, which includes a thorough assessment, may take a bit longer, typically around <span className="font-bold">45 minutes to an hour</span>. During this first visit, our chiropractor will conduct a comprehensive evaluation, which includes discussing your medical history, performing physical exams, and possibly taking X-rays if necessary. This thorough assessment helps us understand your condition and create a personalized treatment plan.</p>
                <p className="mb-4"><span className="font-bold">Follow-Up Sessions:</span> Subsequent chiropractic sessions, which involve spinal adjustments and other therapeutic interventions, are typically shorter in duration. The chiropractor will focus on the specific areas of concern and perform adjustments or other manual therapies as needed to address your musculoskeletal issues.</p>
                <p className="mb-4">Our goal is to provide you with effective care that meets your individual needs while respecting your time constraints. Your chiropractor will work with you to develop a treatment plan that not only addresses your condition but also fits your schedule.</p>
                <p>If you have any questions about the duration of chiropractic sessions or would like to discuss your specific needs, please feel free to reach out to us. We are here to provide you with the highest quality care and ensure your comfort throughout the treatment process.</p>
            </div>
        )
    },
    {
        ...
        a: (
            <div>
                ...
                <ul className="list-disc pl-6 space-y-3 mb-4">
                    ...
                    <li>
                        <span className="font-bold">Hips, Knees, and Ankles:</span> We address these critical weight-bearing joints with an interdisciplinary approach. Through therapeutic exercises, gait training, acupuncture, and lifestyle adaptations, we manage and treat conditions like hip bursitis, knee osteoarthritis, ACL/MCL injuries, meniscal tears, and more, aiming to restore functionality and improve your daily life quality.
                    </li>
                </ul>
    ...
    },
    {
        ...
        a: (
            <div>
                ...
                <ul className="list-disc pl-6 space-y-3 mb-4">
                    <li>
                        <span className="font-bold">Chiropractic Care:</span>
                        <ul className="list-disc pl-6 mt-1 space-y-1">
                            <li><span className="font-bold">Services:</span> Spinal alignment and extremity joint adjustments, spinal and joint mobilization, X-rays for diagnosis, manual therapies like Myofascial release and Graston Technique, therapeutic exercises, electric stimulation, therapeutic ultrasound, Kinesio Taping, Cold Laser Therapy, Mechanical Traction Decompression, and Electromyography/Nerve Conduction Velocity (EMG/NCV) Studies.</li>
                            <li><span className="font-bold">Therapeutic Benefits:</span> Highly effective for correcting spinal and joint misalignments, alleviating pain, improving mobility, and addressing complex musculoskeletal issues. It can also help with pain control, scar tissue management, and promoting faster healing.</li>
                        </ul>
                    </li>
                    <li>
                    ...
                    <li>
                        <span className="font-bold">Occupational Therapy:</span>
                        <ul className="list-disc pl-6 mt-1 space-y-1">
                            <li><span className="font-bold">Services:</span> Designed to help you regain functional independence in your daily life, incorporating ADL and IADL training, cognitive rehabilitation, sensory integration therapy, and visual rehabilitation.</li>
                            <li><span className="font-bold">Therapeutic Benefits:</span> Aids in enhancing cognitive function, improving sensory processing, and facilitating independent living, particularly for those who may have experienced injuries or have special needs.</li>
                        </ul>
                    </li>
                    <li>
                        <span className="font-bold">Acupuncture:</span>
                        <ul className="list-disc pl-6 mt-1 space-y-1">
                            <li><span className="font-bold">Services:</span> Our skilled Acupuncturists utilize acupuncture techniques to stimulate specific points on the body, promoting natural healing and relaxation.</li>
                            <li><span className="font-bold">Therapeutic Benefits:</span> Known for its holistic healing benefits, reducing pain, stress, and anxiety, and improving overall wellness.</li>
                        </ul>
                    </li>
                    <li>
