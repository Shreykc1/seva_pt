...
const AboutSection = () => {
    const stats = [
        ...
        { icon: <MapPin className="w-8 h-8" />, number: '1', label: 'NYC Locations' },
            ...
            <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
                <div className="grid grid-cols-1 lg:grid-cols-2 gap-16 items-center">
                    ...
                    <div>
                        ...
                        <Link
                            to="/what-we-offer"
                            className="bg-orange-600 hover:bg-orange-700 text-white px-8 py-4 rounded-lg font-semibold transition-colors text-base inline-block text-center"
                        >
